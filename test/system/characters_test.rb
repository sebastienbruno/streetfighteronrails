...
class CharactersTest < ApplicationSystemTestCase
  ...
  test "creating a Character" do
    ...
    fill_in "Current life", with: @character.current_life
    fill_in "Damage attack", with: @character.damage_attack
    fill_in "Experience", with: @character.experience
    fill_in "Name", with: @character.name
    fill_in "Picture", with: @character.picture
    fill_in "Shield", with: @character.shield
